...
# hard link instead of a 2GB copy per image (the rootfs is never modified in place)
ln -f "${BINARIES_DIR}/rootfs.squashfs"	"${BATOCERA_BINARIES_DIR}/boot/boot/knulli.update"	2>/dev/null || \
